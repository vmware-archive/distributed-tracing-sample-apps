...
public class JerseyConfig extends ResourceConfig {
  ...
  public JerseyConfig() throws IOException {
    ...
    dropwizardMetricsBuilder.withSource("xtong-shopping-source");
    ...
    jerseyReporterBuilder.withSource("xtong-shopping-source");
    ...
    wfJvmReporterBuilder.withSource("xtong-shopping-source");
    ...
    Reporter wfSpanReporter = new WavefrontSpanReporter.Builder().
            withSource("xtong-shopping-source"). // optional nondefault source name
    ...
    register(new ShoppingController(tracer));
  }
