...
public class JerseyConfig extends ResourceConfig {
  ...
  public JerseyConfig() throws IOException {
    ...
    dropwizardMetricsBuilder.withSource("xtong-styling-source");
    ...
    jerseyReporterBuilder.withSource("xtong-styling-source");
    ...
    Reporter wfSpanReporter = new WavefrontSpanReporter.Builder().
            withSource("xtong-styling-source"). // optional nondefault source name
